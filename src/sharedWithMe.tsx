...
import { ShareWithMeProp, SharedWithMeContentProps } from './types';
...
export class SharedWithMeListWrapper extends ReactWidget {
...
const SharedWithMeContent = (props: SharedWithMeContentProps): JSX.Element => {
  const [shareList, setShareList] = useState([]);

  const refreshPendingShares = async (): Promise<void> => {
    requestAPI('/api/cs3/shares/received?status=accepted', {
      method: 'GET'
...
const SharedWithMeElement = (props: ShareWithMeProp): JSX.Element => {
